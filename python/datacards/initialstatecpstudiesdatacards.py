...
class InitialStateCPStudiesDatacards(smhttdatacards.SMHttDatacards):
	def __init__(self, higgs_masses=["125"], useRateParam=False, year="", cb=None, signal_processes=[ "qqH", "ggHsm","ggHps_ALT"]):
		super(InitialStateCPStudiesDatacards, self).__init__(higgs_masses,useRateParam,year,cb, signal_processes=["qqH", "ggHsm","ggHps_ALT"])
