...
class ExpressionsDict(expressions.ExpressionsDict):
	def __init__(self, additional_expressions=None):
		...
		for channel in ["et","mt","tt","em","mm"]:
			...
			self.expressions_dict["catHwwMSSM13TeV_"+channel+"_inclusive"] = "(1.0)" # HWW
		...
		for cat in ["_nobtag","_btag","_inclusive"]:
			...
			self.expressions_dict["catHwwMSSM13TeV_em"+cat+"_lowPzeta"] = self.expressions_dict["catHwwMSSM13TeV_em"+cat]+"*(pZetaMissVis > -50)*(pZetaMissVis < -10)" # HWW
