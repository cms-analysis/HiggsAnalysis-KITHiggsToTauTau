...
class ExpressionsDict(expressions.ExpressionsDict):
	def __init__(self, additional_expressions=None):
		...
		for channel in ["tt", "mt", "et", "em", "mm", "ee"]:
			...
			self.expressions_dict["catZtt13TeV_"+channel+"_1jet_medium"] = "(pt_tt>50)*(pt_tt<100)*(nbtag<1)*((njetspt30==1)|| (njetspt30>1 && (!(mjj>500 && jdeta>3.5)) ) )"
			self.expressions_dict["catZtt13TeV_"+channel+"_1jet_high"] = "(pt_tt>100)*(nbtag<1)*((njetspt30==1)|| (njetspt30>1 && (!(mjj>500 && jdeta>3.5)) ) )"
