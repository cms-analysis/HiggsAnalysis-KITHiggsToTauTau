	...
	def __init__(self, color_scheme="default", additional_colors=None):
		...
		if color_scheme.lower() == "kit":
			...
			for nick_suffix in ["", "_os_highmt", "_ss_highmt", "_ss_lowmt"]:
				...
				self.colors_dict["ztt_gendm0_2"+nick_suffix] = "#FF6633"
				self.colors_dict["ztt_gendm1_2"+nick_suffix] = "#FFCC66"
				self.colors_dict["ztt_gendm2_2"+nick_suffix] = "#FFDD88"
				self.colors_dict["ztt_gendm10_2"+nick_suffix] = "#FFFFCC"
				self.colors_dict["ztt_gendm11_2"+nick_suffix] = "#FFFF88"
