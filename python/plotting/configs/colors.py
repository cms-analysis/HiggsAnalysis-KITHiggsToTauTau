...
class ColorsDict(colors.ColorsDict):
	def __init__(self, color_scheme="default", additional_colors=None):
		...
		if color_scheme.lower() == "kit":
			...
			self.colors_dict["bbh"] = self.colors_dict["kit_gruen_1"]
			self.colors_dict["gghsm"] = self.colors_dict["vega_cat1_01"]
			self.colors_dict["gghsm_htt125"] = self.colors_dict["vega_cat1_01"]
			self.colors_dict["gghjhusm"] = self.colors_dict["gghsm"]
			self.colors_dict["gghmm"] = self.colors_dict["vega_cat1_05"]
			self.colors_dict["gghmm_htt125"] = self.colors_dict["vega_cat1_05"]
			self.colors_dict["gghjhumm"] = self.colors_dict["gghmm"]
			self.colors_dict["gghps"] = self.colors_dict["vega_cat1_04"]
			self.colors_dict["gghps_htt125"] = self.colors_dict["vega_cat1_04"]
			self.colors_dict["gghjhups"] = self.colors_dict["gghps"]
			self.colors_dict["gghps_alt"] = self.colors_dict["kit_cyanblau_1"]
			self.colors_dict["gghmm_alt"] = self.colors_dict["kit_rot_1"]
			self.colors_dict["qqh"] = self.colors_dict["kit_gruen_1"]
			self.colors_dict["qqhsm"] = self.colors_dict["vega_cat1_02"]
			self.colors_dict["qqhsm_htt125"] = self.colors_dict["vega_cat1_02"]
			self.colors_dict["qqhjhusm"] = self.colors_dict["qqhsm"]
			self.colors_dict["qqhmm"] = self.colors_dict["vega_cat1_06"]
			self.colors_dict["qqhmm_htt125"] = self.colors_dict["vega_cat1_06"]
			self.colors_dict["qqhjhumm"] = self.colors_dict["qqhmm"]
			self.colors_dict["qqhps"] = self.colors_dict["vega_cat1_03"]
			self.colors_dict["qqhps_htt125"] = self.colors_dict["vega_cat1_03"]
			self.colors_dict["qqhjhups"] = self.colors_dict["qqhps"]
			...
			self.colors_dict["zh"]  = self.colors_dict["kit_lila_1"]
			self.colors_dict["zh_htt"]  = self.colors_dict["kit_lila_1"]
			self.colors_dict["wh"]  = self.colors_dict["kit_lila_1"]			
			self.colors_dict["wh_htt"]  = self.colors_dict["kit_lila_1"]			
			self.colors_dict["totalsig"] = self.colors_dict["htt"]
			self.colors_dict["hww"] = self.colors_dict["kit_lila_3"]+" "+self.colors_dict["kit_lila_4"]
			self.colors_dict["hww120"] = self.colors_dict["hww"]
			self.colors_dict["hww125"] = self.colors_dict["hww"]
			...
			self.colors_dict["hww_gg120"] = self.colors_dict["hww"]
			self.colors_dict["hww_gg125"] = self.colors_dict["hww"]
			self.colors_dict["ggh_hww125"] = self.colors_dict["hww"]
			self.colors_dict["hww_gg130"] = self.colors_dict["hww"]
			self.colors_dict["hww_qq120"] = self.colors_dict["hww"]
			self.colors_dict["hww_qq125"] = self.colors_dict["hww"]
			self.colors_dict["qqh_hww125"] = self.colors_dict["hww"]
			self.colors_dict["hww_qq130"] = self.colors_dict["hww"]
			self.colors_dict["totalbkg"] = "#000000 transgrey"
			self.colors_dict["ff"] = self.colors_dict["kit_grau_2"]
			self.colors_dict["httcpeven"] = self.colors_dict["rwth_blau_050"]
