...
class ColorsDict(colors.ColorsDict):
	def __init__(self, color_scheme="default", additional_colors=None):
		...
		for nick_suffix in ["", "_os_highmt", "_ss_highmt", "_ss_lowmt"]:
			...
			self.colors_dict["ttt"+nick_suffix] = self.colors_dict["tt"] #"#8888C4 #8888C4" # "#000040 #000040"
			self.colors_dict["ttjj"+nick_suffix] = "#AAAAD5 #AAAAD5" # self.colors_dict["tt"]
			self.colors_dict["ttl"+nick_suffix] = "#DE5A6A #DE5A6A" #"#BBBBDD #BBBBDD" # self.colors_dict["tt"]
			...
			self.colors_dict["vvl"+nick_suffix]  = "#000040 #000040" # self.colors_dict["kit_gelb_2"]
			...
			self.colors_dict["ggh_sm_htt"+nick_suffix] = self.colors_dict["gghsm"]
			...
			self.colors_dict["ggh_mm_htt"+nick_suffix] = self.colors_dict["gghmm"]
			...
			self.colors_dict["ggh_ps_htt"+nick_suffix] = self.colors_dict["gghps"]
			...
			self.colors_dict["qqh_sm_htt"+nick_suffix] = self.colors_dict["qqhsm"]
			...
			self.colors_dict["qqh_mm_htt"+nick_suffix] = self.colors_dict["qqhmm"]
			...
			self.colors_dict["qqh_ps_htt"+nick_suffix] = self.colors_dict["qqhps"]
