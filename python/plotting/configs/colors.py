	...
	def __init__(self, color_scheme="default", additional_colors=None):
		...
		if color_scheme.lower() == "kit":
			...
			for nick_suffix in ["", "_os_highmt", "_ss_highmt", "_ss_lowmt"]:
				...
				self.colors_dict["zmte"+nick_suffix] = "#000000 #CE66FF"
				self.colors_dict["zetm"+nick_suffix] = "#000000 #CE66FF"
				...
				self.colors_dict["vv"+nick_suffix]  = "#000000 #6F2D35"
				...
				self.colors_dict["qcd"+nick_suffix] = "#000000 #FFCCFF"
				...
				self.colors_dict["gghjhusm"+nick_suffix] = self.colors_dict["material_blue2"] #self.colors_dict["gghsm"]
				...
				self.colors_dict["gghjhumm"+nick_suffix] = self.colors_dict["material_green"] #self.colors_dict["gghmm"]
				...
				self.colors_dict["gghjhups"+nick_suffix] = self.colors_dict["material_orange"] #self.colors_dict["gghps"]
				...
				self.colors_dict["qqh"+nick_suffix] = self.colors_dict["material_petrol"] #self.colors_dict["kit_gruen_1"]
		...
		for higgs_mass in xrange(90, 161, 5):
			...
			for scale in [10, 25, 100, 250]:
				...
				self.colors_dict["gghjhusm{mass:d}_{scale:d}".format(mass=higgs_mass, scale=scale)] = self.colors_dict["gghjhusm"]
				self.colors_dict["gghjhumm{mass:d}_{scale:d}".format(mass=higgs_mass, scale=scale)] = self.colors_dict["gghjhumm"]
				self.colors_dict["gghjhups{mass:d}_{scale:d}".format(mass=higgs_mass, scale=scale)] = self.colors_dict["gghjhups"]				
