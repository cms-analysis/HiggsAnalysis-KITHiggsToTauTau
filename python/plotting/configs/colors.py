...
class ColorsDict(colors.ColorsDict):
	def __init__(self, color_scheme="default", additional_colors=None):
		...
		if color_scheme.lower() == "kit":
			...
			self.colors_dict["susycpoddALT"] = self.colors_dict["rwth_rot_100"]
			...
			for nick_suffix in ["", "_os_highmt", "_ss_highmt", "_ss_lowmt"]:
				...
				self.colors_dict["susycpoddALT"+nick_suffix] = self.colors_dict["rwth_rot_100"]
		...
		for higgs_mass in xrange(90, 161, 5):
			...
			self.colors_dict["susycpoddALT{mass:d}".format(mass=higgs_mass)] = self.colors_dict["susycpoddALT"]
			...
			for scale in [10, 25, 100, 250]:
				...
				self.colors_dict["susycpoddALT{mass:d}_{scale:d}".format(mass=higgs_mass, scale=scale)] = self.colors_dict["susycpoddALT{mass:d}".format(mass=higgs_mass)]
