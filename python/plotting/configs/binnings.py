...
class BinningsDict(binnings.BinningsDict):
	def __init__(self, additional_binnings=None):
		...
		self.binnings_dict["tt_pzetamiss"] = "40,-100.0,100.0"
		self.binnings_dict["tt_pzetavis"] = "20,0.0,100.0"
		self.binnings_dict["tt_metProjectionPar"] = "20,-100.0,300.0"
		self.binnings_dict["tt_metProjectionPerp"] = "20,-100.0,100.0"
		...
		self.binnings_dict["mt_metProjectionPerp"] = "20,-100.0,100.0"
		...
		self.binnings_dict["mt_pzetamiss"] = "40,-100.0,100.0"
		self.binnings_dict["mt_pzetavis"] = "20,0.0,100.0"
		self.binnings_dict["mt_metProjectionPar"] = "21,-20.0,200.0"
		self.binnings_dict["mt_metProjectionPerp"] = "20,-50.0,50.0"
		self.binnings_dict["mt_metProjectionPhi"] = "20,-3.141,3.141"
		...
		self.binnings_dict["et_metProjectionPerp"] = "20,-100.0,100.0"
		...
		self.binnings_dict["et_pzetamiss"] = "20,-100.0,100.0"
		self.binnings_dict["et_pzetavis"] = "20,0.0,100.0"
		self.binnings_dict["et_metProjectionPar"] = "21,-20.0,200.0"
		self.binnings_dict["et_metProjectionPerp"] = "20,-50.0,50.0"
		self.binnings_dict["et_metProjectionPhi"] = "20,-3.141,3.141"
		...
		self.binnings_dict["em_metProjectionPerp"] = "20,-100.0,100.0"
		...
		self.binnings_dict["em_pzetamiss"] = "20,-100.0,100.0"
