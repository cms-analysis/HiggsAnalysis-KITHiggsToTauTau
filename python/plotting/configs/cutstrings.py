...
class CutStringsDict:
	...
	def baseline(channel, cut_type):
		...
		if channel == "mm":
			...
			cuts["iso_1"] = "(byTightIsolationMVArun2v1DBoldDMwLT_1 > 0.5)*((gen_match_2 == 5)*0.95 + (gen_match_2 != 5))" if "2016" in cut_type else "(byVTightIsolationMVArun2v1DBoldDMwLT_2 > 0.5)"
	...
	def relaxedETauMuTauWJ(channel, cut_type):
		if channel in ["mt", "et"]:
			...
			cuts["iso_2"] = "(byMediumIsolationMVArun2v1DBoldDMwLT_2 > 0.5)*((gen_match_2 == 5)*0.95 + (gen_match_2 != 5))" if "smhtt2016" else "(byMediumIsolationMVArun2v1DBoldDMwLT_2 > 0.5)*((gen_match_2 == 5)*0.97 + (gen_match_2 != 5))" if "2016" in cut_type else "(byMediumIsolationMVArun2v1DBoldDMwLT_2 > 0.5)"
		elif channel in ["em"]:
			cuts = CutStringsDict.baseline(channel, cut_type)
			cuts["iso_1"] = "(iso_1 < 0.3)"
