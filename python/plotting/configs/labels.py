	...
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			for channel in ["ee", "em", "et", "mm", "mt", "tt"]:
				...
				self.labels_dict[channel+"_ptvis"] = "Visible Di-lepton p_{T} / GeV"
			...
			self.labels_dict["tt_pZetaMissVis"] = "#left(p_{#zeta} #minus 1.85 p^{vis}_{#zeta}#right) / GeV"
			...
			self.labels_dict["mt_pZetaMissVis"] = "#left(p_{#zeta} #minus 1.85 p^{vis}_{#zeta}#right) / GeV"
			...
			self.labels_dict["et_pZetaMissVis"] = "#left(p_{#zeta} #minus 1.85 p^{vis}_{#zeta}#right) / GeV"
			...
			self.labels_dict["em_mt_i"] = "\mathrm{m}_\mathrm{T,improved}^{\ell\ell,\mathrm{MEt}}\,/\,\mathrm{GeV}"
			...
			self.labels_dict["em_dphi"] = "#phi_{#mu}-#phi_{e}"
			...
			self.labels_dict["em_pZetaMissVis"] = "#left(p_{#zeta} #minus 1.85 p^{vis}_{#zeta}#right) / GeV"
			...
			self.labels_dict["em_dcosphi"] = "cos(#Delta#phi)"
			...
			self.labels_dict["tt_pZetaMissVis"] = "$\\left(\\mathrm{p}_{\\zeta}\\,\\minus 1.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["mt_pZetaMissVis"] = "$\\left(\\mathrm{p}_{\\zeta}\\,\\minus 1.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["et_pZetaMissVis"] = "$\\left(\\mathrm{p}_{\\zeta}\\,\\minus 1.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["em_mt_tot"] = "$\\mathrm{Total}\\,\\mathrm{Transverse}\\,\\mathrm{Mass}\\,\\mathrm{m}^{\\mathrm{tot}}_{\\mathrm{T}} / \\mathrm{GeV}$"
			...
			self.labels_dict["em_dphi"] = "$\\phi_{\\mu}$-\\phi_{\\mathrm{e}}$"
			self.labels_dict["em_phi_ll"] = "$\\phi^{\\ell\\ell}$"
			self.labels_dict["em_phi_llmet"] = "$\\phi^{\\ell\\ell,\\mathrm{MEt}}$"
			...
			self.labels_dict["em_pZetaMissVis"] = "$\\left(\\mathrm{p}_{\\zeta}\\,\\minus 1.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["em_dcosphi"] = "\\mathrm{cos}(\\Delta\\phi)"
