...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["tt_jpt_1"] = "Leading Jet p_{T}"
			self.labels_dict["tt_jpt_2"] = "Trailing Jet p_{T}"
			self.labels_dict["tt_m_1"] = "Leading Tau Mass"
			self.labels_dict["tt_m_2"] = "Trailing Tau Mass"
			self.labels_dict["tt_m_ll"] = "m^{ll}"
			self.labels_dict["tt_m_llmet"] = "m^{ll,MEt}"
			self.labels_dict["tt_m_sv"] = "SVfit Mass m(#tau#tau)"
			self.labels_dict["tt_met"] = "PFlow E^{miss}_{T}"
			self.labels_dict["tt_metcov00"] = "Cov_{0,0}(MET)"
			self.labels_dict["tt_metcov01"] = "Cov_{0,1}(MET)"
			self.labels_dict["tt_metcov10"] = "Cov_{1,0}(MET)"
			self.labels_dict["tt_metcov11"] = "Cov_{1,1}(MET)"
			self.labels_dict["tt_metphi"] = "PFlow E^{miss}_{T} #phi"
			self.labels_dict["tt_mjj"] = "m_{jj}"
			self.labels_dict["tt_mt_1"] = "m_{T} (#tau, E^{miss}_{T})"
			self.labels_dict["tt_mt_lep1met"] = "m_{T}^{tau,MEt}"
			self.labels_dict["tt_mt_ll"] = "m_{T}^{ll}"
			self.labels_dict["tt_mt_llmet"] = "m_{T}^{ll,MEt}"
			self.labels_dict["tt_mvacov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["tt_mvacov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["tt_mvacov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["tt_mvacov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["tt_mvamet"] = "MVA MET"
			self.labels_dict["tt_mvametcov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["tt_mvametcov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["tt_mvametcov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["tt_mvametcov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["tt_mvametphi"] = "#phi(MVA MET)"
			self.labels_dict["tt_m_vis"] = "m^{vis}_{#tau#tau}"
			...
			self.labels_dict["tt_pt_1"] = "Leading Tau p_{T}"
			self.labels_dict["tt_pt_2"] = "Trailing Tau p_{T}"
			self.labels_dict["tt_pt_ll"] = "p_{T}^{ll}"
			self.labels_dict["tt_pt_llmet"] = "p_{T}^{ll,MEt}"
			self.labels_dict["tt_pt_sv"] = "SVfit p_{T}(#tau#tau)"
			self.labels_dict["tt_pt_tt"] = "p_{T}(#tau#tau)"
			self.labels_dict["tt_puweight"] = "PU Weight"
			self.labels_dict["tt_rho"] = "rho"
			self.labels_dict["tt_svfitMass"] = "SVfit Mass m(#tau#tau)"
			...
			self.labels_dict["mt_jpt_1"] = "Leading Jet p_{T}"
			self.labels_dict["mt_jpt_2"] = "Trailing Jet p_{T}"
			self.labels_dict["mt_m_1"] = "Muon Mass"
			self.labels_dict["mt_m_2"] = "Tau Mass"
			self.labels_dict["mt_m_ll"] = "m^{ll}"
			self.labels_dict["mt_m_llmet"] = "m^{ll,MEt}"
			self.labels_dict["mt_m_sv"] = "SVfit Mass m(#tau#tau)"
			self.labels_dict["mt_met"] = "PFlow E^{miss}_{T}"
			self.labels_dict["mt_metcov00"] = "Cov_{0,0}(MET)"
			self.labels_dict["mt_metcov01"] = "Cov_{0,1}(MET)"
			self.labels_dict["mt_metcov10"] = "Cov_{1,0}(MET)"
			self.labels_dict["mt_metcov11"] = "Cov_{1,1}(MET)"
			self.labels_dict["mt_metphi"] = "PFlow E^{miss}_{T} #phi"
			self.labels_dict["mt_mjj"] = "m_{jj}"
			self.labels_dict["mt_mt_1"] = "m_{T} (#mu, E^{miss}_{T})"
			self.labels_dict["mt_mt_lep1met"] = "m_{T}^{mu,MEt}"
			self.labels_dict["mt_mt_ll"] = "m_{T}^{ll}"
			self.labels_dict["mt_mt_llmet"] = "m_{T}^{ll,MEt}"
			self.labels_dict["mt_mvacov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["mt_mvacov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["mt_mvacov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["mt_mvacov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["mt_mvamet"] = "MVA MET"
			self.labels_dict["mt_mvametcov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["mt_mvametcov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["mt_mvametcov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["mt_mvametcov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["mt_mvametphi"] = "#phi(MVA MET)"
			self.labels_dict["mt_m_vis"] = "m^{vis}_{#tau#tau}"
			...
			self.labels_dict["mt_pt_1"] = "Muon p_{T}"
			self.labels_dict["mt_pt_2"] = "Tau p_{T}"
			self.labels_dict["mt_pt_ll"] = "p_{T}^{ll}"
			self.labels_dict["mt_pt_llmet"] = "p_{T}^{ll,MEt}"
			self.labels_dict["mt_pt_sv"] = "SVfit p_{T}(#tau#tau)"
			self.labels_dict["mt_pt_tt"] = "p_{T}(#tau#tau)"
			self.labels_dict["mt_puweight"] = "PU Weight"
			self.labels_dict["mt_rho"] = "rho"
			self.labels_dict["mt_svfitMass"] = "SVfit Mass m(#tau#tau)"
			...
			self.labels_dict["et_jpt_1"] = "Leading Jet p_{T}"
			self.labels_dict["et_jpt_2"] = "Trailing Jet p_{T}"
			self.labels_dict["et_m_1"] = "Electron Mass"
			self.labels_dict["et_m_2"] = "Tau Mass"
			self.labels_dict["et_m_ll"] = "m^{ll}"
			self.labels_dict["et_m_llmet"] = "m^{ll,MEt}"
			self.labels_dict["et_m_sv"] = "SVfit Mass m(#tau#tau)"
			self.labels_dict["et_met"] = "PFlow E^{miss}_{T}"
			self.labels_dict["et_metcov00"] = "Cov_{0,0}(MET)"
			self.labels_dict["et_metcov01"] = "Cov_{0,1}(MET)"
			self.labels_dict["et_metcov10"] = "Cov_{1,0}(MET)"
			self.labels_dict["et_metcov11"] = "Cov_{1,1}(MET)"
			self.labels_dict["et_metphi"] = "PFlow E^{miss}_{T} #phi"
			self.labels_dict["et_mjj"] = "m_{jj}"
			self.labels_dict["et_mt_1"] = "m_{T} (e, E^{miss}_{T})"
			self.labels_dict["et_mt_lep1met"] = "m_{T}^{e,MEt}"
			self.labels_dict["et_mt_ll"] = "m_{T}^{ll}"
			self.labels_dict["et_mt_llmet"] = "m_{T}^{ll,MEt}"
			self.labels_dict["et_mvacov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["et_mvacov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["et_mvacov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["et_mvacov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["et_mvamet"] = "MVA MET"
			self.labels_dict["et_mvametcov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["et_mvametcov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["et_mvametcov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["et_mvametcov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["et_mvametphi"] = "#phi(MVA MET)"
			self.labels_dict["et_m_vis"] = "m^{vis}_{#tau#tau}"
			...
			self.labels_dict["et_pt_1"] = "Electron p_{T}"
			self.labels_dict["et_pt_2"] = "Tau p_{T}"
			self.labels_dict["et_pt_ll"] = "p_{T}^{ll}"
			self.labels_dict["et_pt_llmet"] = "p_{T}^{ll,MEt}"
			self.labels_dict["et_pt_sv"] = "SVfit p_{T}(#tau#tau)"
			self.labels_dict["et_pt_tt"] = "p_{T}(#tau#tau)"
			self.labels_dict["et_puweight"] = "PU Weight"
			self.labels_dict["et_rho"] = "rho"
			self.labels_dict["et_svfitMass"] = "SVfit Mass m(#tau#tau)"
			...
			self.labels_dict["em_jpt_1"] = "Leading Jet p_{T}"
			self.labels_dict["em_jpt_2"] = "Trailing Jet p_{T}"
			self.labels_dict["em_m_1"] = "Electron Mass"
			self.labels_dict["em_m_2"] = "Muon Mass"
			self.labels_dict["em_m_ll"] = "m^{ll}"
			self.labels_dict["em_m_llmet"] = "m^{ll,MEt}"
			self.labels_dict["em_m_sv"] = "SVfit Mass m(#tau#tau)"
			self.labels_dict["em_met"] = "PFlow E^{miss}_{T}"
			self.labels_dict["em_metcov00"] = "Cov_{0,0}(MET)"
			self.labels_dict["em_metcov01"] = "Cov_{0,1}(MET)"
			self.labels_dict["em_metcov10"] = "Cov_{1,0}(MET)"
			self.labels_dict["em_metcov11"] = "Cov_{1,1}(MET)"
			self.labels_dict["em_metphi"] = "PFlow E^{miss}_{T} #phi"
			self.labels_dict["em_mjj"] = "m_{jj}"
			self.labels_dict["em_mt_1"] = "m_{T} (e, E^{miss}_{T})"
			self.labels_dict["em_mt_lep1met"] = "m_{T}^{e,MEt}"
			self.labels_dict["em_mt_ll"] = "m_{T}^{ll}"
			self.labels_dict["em_mt_llmet"] = "m_{T}^{ll,MEt}"
			self.labels_dict["em_mvacov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["em_mvacov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["em_mvacov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["em_mvacov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["em_mvamet"] = "MVA MET"
			self.labels_dict["em_mvametcov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["em_mvametcov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["em_mvametcov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["em_mvametcov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["em_mvametphi"] = "#phi(MVA MET)"
			self.labels_dict["em_m_vis"] = "m^{vis}_{#tau#tau}"
			...
			self.labels_dict["em_pt_1"] = "Electron p_{T}"
			self.labels_dict["em_pt_2"] = "Muon p_{T}"
			self.labels_dict["em_pt_ll"] = "p_{T}^{ll}"
			self.labels_dict["em_pt_llmet"] = "p_{T}^{ll,MEt}"
			self.labels_dict["em_pt_sv"] = "SVfit p_{T}(#tau#tau)"
			self.labels_dict["em_pt_tt"] = "p_{T}(#tau#tau)"
			self.labels_dict["em_puweight"] = "PU Weight"
			self.labels_dict["em_rho"] = "rho"
			self.labels_dict["em_svfitMass"] = "SVfit Mass m(#tau#tau)"
			...
			self.labels_dict["mm_jpt_1"] = "Leading Jet p_{T}"
			self.labels_dict["mm_jpt_2"] = "Trailing Jet p_{T}"
			self.labels_dict["mm_m_1"] = "Leading Muon Mass"
			self.labels_dict["mm_m_2"] = "Trailing Muon Mass"
			self.labels_dict["mm_m_ll"] = "m^{ll}"
			self.labels_dict["mm_m_llmet"] = "m^{ll,MEt}"
			self.labels_dict["mm_m_sv"] = "SVfit Mass m(#tau#tau)"
			self.labels_dict["mm_met"] = "PFlow E^{miss}_{T}"
			self.labels_dict["mm_metcov00"] = "Cov_{0,0}(MET)"
			self.labels_dict["mm_metcov01"] = "Cov_{0,1}(MET)"
			self.labels_dict["mm_metcov10"] = "Cov_{1,0}(MET)"
			self.labels_dict["mm_metcov11"] = "Cov_{1,1}(MET)"
			self.labels_dict["mm_metphi"] = "PFlow E^{miss}_{T} #phi"
			self.labels_dict["mm_mjj"] = "m_{jj}"
			self.labels_dict["mm_mt_1"] = "m_{T} (#mu, E^{miss}_{T})"
			self.labels_dict["mm_mt_lep1met"] = "m_{T}^{mu,MEt}"
			self.labels_dict["mm_mt_ll"] = "m_{T}^{ll}"
			self.labels_dict["mm_mt_llmet"] = "m_{T}^{ll,MEt}"
			self.labels_dict["mm_mvacov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["mm_mvacov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["mm_mvacov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["mm_mvacov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["mm_mvamet"] = "MVA MET"
			self.labels_dict["mm_mvametcov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["mm_mvametcov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["mm_mvametcov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["mm_mvametcov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["mm_mvametphi"] = "#phi(MVA MET)"
			self.labels_dict["mm_m_vis"] = "m^{vis}_{#tau#tau}"
			...
			self.labels_dict["mm_pt_1"] = "Leading Muon p_{T}"
			self.labels_dict["mm_pt_2"] = "Trailing Muon p_{T}"
			self.labels_dict["mm_pt_ll"] = "p_{T}^{ll}"
			self.labels_dict["mm_pt_llmet"] = "p_{T}^{ll,MEt}"
			self.labels_dict["mm_pt_sv"] = "SVfit p_{T}(#tau#tau)"
			self.labels_dict["mm_pt_tt"] = "p_{T}(#tau#tau)"
			self.labels_dict["mm_puweight"] = "PU Weight"
			self.labels_dict["mm_rho"] = "rho"
			self.labels_dict["mm_svfitMass"] = "SVfit Mass m(#tau#tau)"
			...
			self.labels_dict["ee_jpt_1"] = "Leading Jet p_{T}"
			self.labels_dict["ee_jpt_2"] = "Trailing Jet p_{T}"
			self.labels_dict["ee_m_1"] = "Electron Mass"
			self.labels_dict["ee_m_2"] = "Muon Mass"
			self.labels_dict["ee_m_ll"] = "m^{ll}"
			self.labels_dict["ee_m_llmet"] = "m^{ll,MEt}"
			self.labels_dict["ee_m_sv"] = "SVfit Mass m(#tau#tau)"
			self.labels_dict["ee_met"] = "PFlow E^{miss}_{T}"
			self.labels_dict["ee_metcov00"] = "Cov_{0,0}(MET)"
			self.labels_dict["ee_metcov01"] = "Cov_{0,1}(MET)"
			self.labels_dict["ee_metcov10"] = "Cov_{1,0}(MET)"
			self.labels_dict["ee_metcov11"] = "Cov_{1,1}(MET)"
			self.labels_dict["ee_metphi"] = "PFlow E^{miss}_{T} #phi"
			self.labels_dict["ee_mjj"] = "m_{jj}"
			self.labels_dict["ee_mt_1"] = "m_{T} (e, E^{miss}_{T})"
			self.labels_dict["ee_mt_lep1met"] = "m_{T}^{e,MEt}"
			self.labels_dict["ee_mt_ll"] = "m_{T}^{ll}"
			self.labels_dict["ee_mt_llmet"] = "m_{T}^{ll,MEt}"
			self.labels_dict["ee_mvacov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["ee_mvacov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["ee_mvacov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["ee_mvacov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["ee_mvamet"] = "MVA MET"
			self.labels_dict["ee_mvametcov00"] = "Cov_{0,0}(MVA MET)"
			self.labels_dict["ee_mvametcov01"] = "Cov_{0,1}(MVA MET)"
			self.labels_dict["ee_mvametcov10"] = "Cov_{1,0}(MVA MET)"
			self.labels_dict["ee_mvametcov11"] = "Cov_{1,1}(MVA MET)"
			self.labels_dict["ee_mvametphi"] = "#phi(MVA MET)"
			self.labels_dict["ee_m_vis"] = "m^{vis}_{#tau#tau}"
			...
			self.labels_dict["ee_pt_1"] = "Electron p_{T}"
			self.labels_dict["ee_pt_2"] = "Muon p_{T}"
			self.labels_dict["ee_pt_ll"] = "p_{T}^{ll}"
			self.labels_dict["ee_pt_llmet"] = "p_{T}^{ll,MEt}"
			self.labels_dict["ee_pt_sv"] = "SVfit p_{T}(#tau#tau)"
			self.labels_dict["ee_pt_tt"] = "p_{T}(#tau#tau)"
			self.labels_dict["ee_puweight"] = "PU Weight"
			self.labels_dict["ee_rho"] = "rho"
			self.labels_dict["ee_svfitMass"] = "SVfit Mass m(#tau#tau)"
