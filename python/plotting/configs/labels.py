...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["tt_mvacov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvacov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvacov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvacov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvamet"] = "MVA #slash{E}_{T} / GeV"
			self.labels_dict["tt_mvametcov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvametcov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvametcov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvametcov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["tt_mvametphi"] = "#phi(MVA #slash{E}_{T})"
			...
			self.labels_dict["mt_mvacov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvacov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvacov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvacov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvamet"] = "MVA #slash{E}_{T} / GeV"
			self.labels_dict["mt_mvametcov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvametcov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvametcov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvametcov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["mt_mvametphi"] = "#phi(MVA #slash{E}_{T})"
			...
			self.labels_dict["et_mvacov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvacov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvacov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvacov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvamet"] = "MVA #slash{E}_{T} / GeV"
			self.labels_dict["et_mvametcov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvametcov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvametcov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvametcov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["et_mvametphi"] = "#phi(MVA #slash{E}_{T})"
			...
			self.labels_dict["em_mvacov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvacov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvacov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvacov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvamet"] = "MVA #slash{E}_{T} / GeV"
			self.labels_dict["em_mvametcov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvametcov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvametcov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvametcov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["em_mvametphi"] = "#phi(MVA #slash{E}_{T})"
			...
			self.labels_dict["mm_mvacov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvacov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvacov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvacov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvamet"] = "MVA #slash{E}_{T} / GeV"
			self.labels_dict["mm_mvametcov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvametcov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvametcov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvametcov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["mm_mvametphi"] = "#phi(MVA #slash{E}_{T})"
			...
			self.labels_dict["ee_mvacov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvacov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvacov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvacov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvamet"] = "MVA #slash{E}_{T} / GeV"
			self.labels_dict["ee_mvametcov00"] = "Cov_{0,0}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvametcov01"] = "Cov_{0,1}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvametcov10"] = "Cov_{1,0}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvametcov11"] = "Cov_{1,1}(MVA #slash{E}_{T})"
			self.labels_dict["ee_mvametphi"] = "#phi(MVA #slash{E}_{T})"
