...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["ee_m_2"] = "electron Mass / GeV"
			...
			self.labels_dict["tt_mt_1"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["tt_mt_lep1met"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["tt_nJets30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["tt_njetspt30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["tt_njets"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["tt_nbtag"] = "$\\mathrm{Number} of \\mathrm{b}-tagged \\mathrm{Jets}$"
			self.labels_dict["tt_njetingap"] = "$\\mathrm{Number} of \\mathrm{central} Jets$"
			...
			self.labels_dict["tt_pZetaMissVis"] = "$\\left(p^{\\mathrm{miss}}_{\\zeta} \\minus 0.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["mt_iso_1"] = "$\\mathrm{Muon} Isolation$"
			self.labels_dict["mt_iso_2"] = "$\\mathrm{Tau} Isolation$"
			...
			self.labels_dict["mt_m_1"] = "$\\mathrm{Muon} Mass / \\mathrm{GeV}$"
			self.labels_dict["mt_m_2"] = "$\\mathrm{Tau} Mass / \\mathrm{GeV}$"
			...
			self.labels_dict["mt_mt_1"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["mt_mt_2"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["mt_mt_lep1met"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["mt_nJets30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["mt_njetspt30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["mt_njets"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["mt_nbtag"] = "$\\mathrm{Number} of \\mathrm{b}-tagged \\mathrm{Jets}$"
			self.labels_dict["mt_njetingap"] = "$\\mathrm{Number} of \\mathrm{central} Jets$"
			...
			self.labels_dict["mt_pZetaMissVis"] = "$\\left(p^{\\mathrm{miss}}_{\\zeta} \\minus 0.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["et_iso_1"] = "$\\mathrm{Electron} Isolation$"
			self.labels_dict["et_iso_2"] = "$\\mathrm{Tau} Isolation$"
			...
			self.labels_dict["et_m_1"] = "$\\mathrm{Electron} Mass / \\mathrm{GeV}$"
			self.labels_dict["et_m_2"] = "$\\mathrm{Tau} Mass / \\mathrm{GeV}$"
			...
			self.labels_dict["et_mt_1"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["et_mt_lep1met"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["et_nJets30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["et_njetspt30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["et_njets"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["et_nbtag"] = "$\\mathrm{Number} of \\mathrm{b}-tagged \\mathrm{Jets}$"
			self.labels_dict["et_njetingap"] = "$\\mathrm{Number} of \\mathrm{central} Jets$"
			...
			self.labels_dict["et_pZetaMissVis"] = "$\\left(p^{\\mathrm{miss}}_{\\zeta} \\minus 0.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["em_iso_1"] = "$\\mathrm{Electron} Isolation$"
			self.labels_dict["em_iso_2"] = "$\\mathrm{Muon} Isolation$"
			...
			self.labels_dict["em_m_1"] = "$\\mathrm{Electron} Mass / \\mathrm{GeV}$"
			self.labels_dict["em_m_2"] = "$\\mathrm{Muon} Mass / \\mathrm{GeV}$"
			...
			self.labels_dict["em_mt_1"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["em_mt_lep1met"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["em_nJets30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["em_njetspt30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["em_njets"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["em_nbtag"] = "$\\mathrm{Number} of \\mathrm{b}-tagged \\mathrm{Jets}$"
			self.labels_dict["em_njetingap"] = "$\\mathrm{Number} of \\mathrm{central} Jets$"
			...
			self.labels_dict["em_pZetaMissVis"] = "$\\left(p^{\\mathrm{miss}}_{\\zeta} \\minus 0.85 \\mathrm{p}^{\\mathrm{vis}}_{\\zeta}\\right) / \\mathrm{GeV}$"
			...
			self.labels_dict["mm_mt_1"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["mm_mt_lep1met"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (\\mu, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["mm_nJets30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["mm_njetspt30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["mm_njets"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["mm_nbtag"] = "$\\mathrm{Number} of \\mathrm{b}-tagged \\mathrm{Jets}$"
			self.labels_dict["mm_njetingap"] = "$\\mathrm{Number} of \\mathrm{central} Jets$"
			...
			self.labels_dict["ee_iso_1"] = "$\\mathrm{Electron} Isolation$"
			self.labels_dict["ee_iso_2"] = "$\\mathrm{Muon} Isolation$"
			...
			self.labels_dict["ee_m_1"] = "$\\mathrm{Electron} Mass / \\mathrm{GeV}$"
			self.labels_dict["ee_m_2"] = "$\\mathrm{electron} Mass / \\mathrm{GeV}$"
			...
			self.labels_dict["ee_mt_1"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["ee_mt_lep1met"] = "$\\mathrm{Transverse} Mass \\mathrm{m}_{\\mathrm{T}} (e, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			...
			self.labels_dict["ee_nJets30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["ee_njetspt30"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["ee_njets"] = "$\\mathrm{Number} of \\mathrm{Jets}$"
			self.labels_dict["ee_nbtag"] = "$\\mathrm{Number} of \\mathrm{b}-tagged \\mathrm{Jets}$"
			self.labels_dict["ee_njetingap"] = "$\\mathrm{Number} of \\mathrm{central} Jets$"
