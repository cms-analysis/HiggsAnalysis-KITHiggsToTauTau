...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["ztt_gendm0_2"] = "Z #rightarrow #tau#tau, gen. 1h^{#pm}"
			self.labels_dict["ztt_gendm1_2"] = "Z #rightarrow #tau#tau, gen. 1h^{#pm} 1#pi^{0}"
			self.labels_dict["ztt_gendm2_2"] = "Z #rightarrow #tau#tau, gen. 1h^{#pm} #geq2#pi^{0}"
			self.labels_dict["ztt_gendm10_2"] = "Z #rightarrow #tau#tau, gen. 3h^{#pm}"
			self.labels_dict["ztt_gendm11_2"] = "Z #rightarrow #tau#tau, gen. 3h^{#pm} #geq1#pi^{0}"
