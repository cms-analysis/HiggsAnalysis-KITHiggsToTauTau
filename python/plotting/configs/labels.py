...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["ztt_gen_dm_zero"] = "Z #rightarrow #tau#tau, gen. 1h^{#pm}"
			self.labels_dict["ztt_gen_dm_one"] = "Z #rightarrow #tau#tau, gen. 1h^{#pm} 1#pi^{0}"
			...
			self.labels_dict["ddzttnegpol"] = "d#bar{d}/s#bar{s}/b#bar{b} #rightarrow Z #rightarrow #tau_{L}^{#minus}#tau_{R}^{#plus}"
