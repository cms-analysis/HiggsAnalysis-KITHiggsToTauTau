...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["tt_mvamet"] = "MVA E^{miss}_{T}"
			...
			self.labels_dict["mt_metPrepjection"] = "Projection#left(E^{miss}_{T}#right)"
			...
			self.labels_dict["mt_mvamet"] = "MVA E^{miss}_{T}"
			...
			self.labels_dict["mt_pzetamiss"] = "p^{miss}_{#zeta}"
			self.labels_dict["mt_pzetavis"] = "p^{vis}_{#zeta}"
			...
			self.labels_dict["et_metPrepjection"] = "Projection#left(E^{miss}_{T}#right)"
			...
			self.labels_dict["et_mvamet"] = "MVA E^{miss}_{T}"
			...
			self.labels_dict["et_pzetamiss"] = "p^{miss}_{#zeta}"
			self.labels_dict["et_pzetavis"] = "p^{vis}_{#zeta}"
			...
			self.labels_dict["em_metPrepjection"] = "Projection#left(E^{miss}_{T}#right)"
			...
			self.labels_dict["em_mvamet"] = "MVA E^{miss}_{T}"
			...
			self.labels_dict["em_pzetamiss"] = "p^{miss}_{#zeta}"
			self.labels_dict["em_pzetavis"] = "p^{vis}_{#zeta}"
			...
			self.labels_dict["mm_mvamet"] = "MVA E^{miss}_{T}"
			...
			self.labels_dict["ee_mvamet"] = "MVA E^{miss}_{T}"
