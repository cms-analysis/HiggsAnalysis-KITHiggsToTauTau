...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["ttj"] = "t#bar{t}"
			self.labels_dict["ttt"] = "t#bar{t} (#tau #rightarrow #tau)"
			self.labels_dict["ttjj"] = "t#bar{t} (jet/pu #rightarrow #tau)"
			self.labels_dict["ttl"] = "t#bar{t} (l #rightarrow #tau)"
			...
			self.labels_dict["vvt"] = "Di-boson (#tau #rightarrow #tau)"
			self.labels_dict["vvl"] = "Di-boson (l #rightarrow #tau)"
			self.labels_dict["vvj"] = "Di-boson (jet/pu #rightarrow #tau)"
			...
			self.labels_dict["channel_cptautau_tt"] = "#tau_{h}#tau_{h}"
			self.labels_dict["channel_cptautau_mt"] = "#tau_{#mu}#tau_{h}"
			self.labels_dict["channel_cptautau_et"] = "#tau_{e}#tau_{h}"
			self.labels_dict["channel_cptautau_em"] = "#tau_{e}#tau_{#mu}"
			self.labels_dict["channel_cptautau_mm"] = "#mu#mu"
			self.labels_dict["channel_cptautau_ee"] = "ee"
			self.labels_dict["channel_cptautau_et_a1e"] = "ea_{1}"
			self.labels_dict["channel_cptautau_mt_a1mu"] = "#mua_{1}"
			self.labels_dict["channel_cptautau_tt_a1a1"] = "a_{1}a_{1}"
			self.labels_dict["channel_cptautau_tt_a1rho"] = "a_{1}#rho"
			self.labels_dict["channel_cptautau_tt_a1pi"] = "a_{1}#pi"
			...
			self.labels_dict["tt_decayModeMVA_1"] = "Leading Tau MVA DM"
			self.labels_dict["tt_decayModeMVA_2"] = "Trailing Tau MVA DM"
			...
			self.labels_dict["tt_pt_large_1"] = self.labels_dict["tt_pt_1"]
			self.labels_dict["tt_pt_large_2"] = self.labels_dict["tt_pt_2"]
			...
			self.labels_dict["tt_helixQOverP_1"] = "Leading Tau Track Q/P"
			self.labels_dict["tt_helixLambda_1"] = "Leading Tau Track #lambda"
			self.labels_dict["tt_helixPhi_1"] = "Leading Tau Track #phi_{0}"
			self.labels_dict["tt_helixDxy_1"] = "Leading Tau Track d_{xy}"
			self.labels_dict["tt_helixDsz_1"] = "Leading Tau Track d_{sz}"
			self.labels_dict["tt_helixQOverP_2"] = "Trailing Track Tau Q/P"
			self.labels_dict["tt_helixLambda_2"] = "Trailing Tau Track #lambda"
			self.labels_dict["tt_helixPhi_2"] = "Trailing Tau Track #phi_{0}"
			self.labels_dict["tt_helixDxy_2"] = "Trailing Tau Track d_{xy}"
			self.labels_dict["tt_helixDsz_2"] = "Trailing Tau Track d_{sz}"
			self.labels_dict["tt_IPSignificanceHelrPVBS_1"] = "Leading Tau Track |#vec{n}|/#sigma_{|#vec{n}|}"
			self.labels_dict["tt_IPSignificanceHelrPVBS_2"] = "Trailing Tau Track |#vec{n}|/#sigma_{|#vec{n}|}"
			...
			self.labels_dict["mt_helixQOverP_1"] = "Muon Track Q/P"
			self.labels_dict["mt_helixLambda_1"] = "Muon Track #lambda"
			self.labels_dict["mt_helixPhi_1"] = "Muon Track #phi_{0}"
			self.labels_dict["mt_helixDxy_1"] = "Muon Track d_{xy}"
			self.labels_dict["mt_helixDsz_1"] = "Muon Track d_{sz}"
			self.labels_dict["mt_helixQOverP_2"] = "Tau Track Q/P"
			self.labels_dict["mt_helixLambda_2"] = "Tau Track #lambda"
			self.labels_dict["mt_helixPhi_2"] = "Tau Track #phi_{0}"
			self.labels_dict["mt_helixDxy_2"] = "Tau Track d_{xy}"
			self.labels_dict["mt_helixDsz_2"] = "Tau Track d_{sz}"
			self.labels_dict["mt_IPSignificanceHelrPVBS_1"] = "Muon Track |#vec{n}|/#sigma_{|#vec{n}|}"
			self.labels_dict["mt_IPSignificanceHelrPVBS_2"] = "Tau Track |#vec{n}|/#sigma_{|#vec{n}|}"
			...
			self.labels_dict["et_helixQOverP_1"] = "Electron Track Q/P"
			self.labels_dict["et_helixLambda_1"] = "Electron Track #lambda"
			self.labels_dict["et_helixPhi_1"] = "Electron Track #phi_{0}"
			self.labels_dict["et_helixDxy_1"] = "Electron Track d_{xy}"
			self.labels_dict["et_helixDsz_1"] = "Electron Track d_{sz}"
			self.labels_dict["et_helixQOverP_2"] = "Tau Track Q/P"
			self.labels_dict["et_helixLambda_2"] = "Tau Track #lambda"
			self.labels_dict["et_helixPhi_2"] = "Tau Track #phi_{0}"
			self.labels_dict["et_helixDxy_2"] = "Tau Track d_{xy}"
			self.labels_dict["et_helixDsz_2"] = "Tau Track d_{sz}"
			self.labels_dict["et_IPSignificanceHelrPVBS_1"] = "Electron Track |#vec{n}|/#sigma_{|#vec{n}|}"
			self.labels_dict["et_IPSignificanceHelrPVBS_2"] = "Tau Track |#vec{n}|/#sigma_{|#vec{n}|}"
			...
			self.labels_dict["channel_cptautau_tt"] = "$\\tau_{\\mathrm{h}}\\tau_{\\mathrm{h}}$"
			self.labels_dict["channel_cptautau_mt"] = "$\\tau_{\\mathrm{\\mu}}\\tau_{\\mathrm{h}}$"
			self.labels_dict["channel_cptautau_et"] = "$\\tau_{\\mathrm{e}}\\tau_{\\mathrm{h}}$"
			self.labels_dict["channel_cptautau_em"] = "$\\tau_{\\mathrm{e}}\\tau_{\\mathrm{\\mu}}$"
			self.labels_dict["channel_cptautau_mm"] = "$\\tau_{\\mathrm{\\mu}}\\tau_{\\mathrm{\\mu}}$"
			self.labels_dict["channel_cptautau_ee"] = "$\\tau_{\\mathrm{e}}\\tau_{\\mathrm{e}}$"
			...
			self.labels_dict["tt_met"] = "$\\slash{\\mathrm{E}}_{\\mathrm{T}} / \\mathrm{GeV}$"
			self.labels_dict["tt_puppimet"] = "$\\mathrm{PFlow}\\,\\slash{\\mathrm{E}}_{\\mathrm{T}} / \\mathrm{GeV}$"
			self.labels_dict["tt_pfmet"] = "$\\mathrm{Puppi}\\,\\slash{\\mathrm{E}}_{\\mathrm{T}} / \\mathrm{GeV}$"
			...
			self.labels_dict["tt_mt_1"] = "$\\mathrm{Transverse}\\,\\mathrm{Mass}\\,\\mathrm{m}_{\\mathrm{T}} (lead. \\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
			self.labels_dict["tt_mt_2"] = "$\\mathrm{Transverse}\\,\\mathrm{Mass}\\,\\mathrm{m}_{\\mathrm{T}} (trail. \\tau, \\slash{\\mathrm{E}}_{\\mathrm{T}}) / \\mathrm{GeV}$"
