...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["tt_metProjectionPar"] = "#nu_{#parallel}"
			self.labels_dict["tt_metProjectionPerp"] = "#nu_{#perp}"
			...
			self.labels_dict["mt_metProjection"] = "Projection#left(E^{miss}_{T}#right)"
			...
			self.labels_dict["mt_metProjectionPar"] = "#nu_{#parallel}"
			self.labels_dict["mt_metProjectionPerp"] = "#nu_{#perp}"
			...
			self.labels_dict["et_metProjection"] = "Projection#left(E^{miss}_{T}#right)"
			...
			self.labels_dict["et_metProjectionPar"] = "#nu_{#parallel}"
			self.labels_dict["et_metProjectionPerp"] = "#nu_{#perp}"
			...
			self.labels_dict["em_metProjection"] = "Projection#left(E^{miss}_{T}#right)"
			...
			self.labels_dict["em_metProjectionPar"] = "#nu_{#parallel}"
			self.labels_dict["em_metProjectionPerp"] = "#nu_{#perp}"
			...
			self.labels_dict["mm_metProjectionPar"] = "#nu_{#parallel}"
			self.labels_dict["mm_metProjectionPerp"] = "#nu_{#perp}"
			...
			self.labels_dict["ee_metProjectionPar"] = "#nu_{#parallel}"
			self.labels_dict["ee_metProjectionPerp"] = "#nu_{#perp}"
