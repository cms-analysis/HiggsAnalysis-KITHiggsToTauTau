	...
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			for channel in ["ee", "em", "et", "mm", "mt", "tt"]:
				...
				self.labels_dict[channel+"_H_pt"] = "p_{T}(#vec{ll}+#vec{jj}+#vec{#slash{E}_{T}}) / GeV"
			...
			self.labels_dict["tt_nbtag"] = "Number of b-\\mathrm{tagged}\\,Jets"
			...
			self.labels_dict["mt_nbtag"] = "Number of b-\\mathrm{tagged}\\,Jets"
			...
			self.labels_dict["et_jdeta"] = "#Delta#eta_{jj}"#Delta R(ll,jj)
			...
			self.labels_dict["et_nbtag"] = "Number of b-\\mathrm{tagged}\\,Jets"
			...
			self.labels_dict["et_pZetaMissVis"] = "#left(p^{miss}_{#zeta} #minus 0.85 p^{vis}#Delta R(ll,jj)_{#zeta}#right) / GeV"
			...
			self.labels_dict["em_nbtag"] = "Number of b-\\mathrm{tagged}\\,Jets"
			...
			self.labels_dict["mm_nbtag"] = "Number of b-\\mathrm{tagged}\\,Jets"
			...
			self.labels_dict["ee_nbtag"] = "Number of b-\\mathrm{tagged}\\,Jets"
