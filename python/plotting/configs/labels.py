...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["tt_metphi"] = "#phi(MET)"
			...
			self.labels_dict["mt_metphi"] = "#phi(MET)"
			...
			self.labels_dict["et_metphi"] = "#phi(MET)"
			...
			self.labels_dict["em_metphi"] = "#phi(MET)"
			...
			self.labels_dict["mm_metphi"] = "#phi(MET)"
			...
			self.labels_dict["ee_metphi"] = "#phi(MET)"
