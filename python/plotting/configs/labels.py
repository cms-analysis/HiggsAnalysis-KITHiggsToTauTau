...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["gghjhusm125"] = "ggH+2j (#alpha=0)"
			self.labels_dict["gghjhups125"] = "ggH+2j (#alpha=#frac{#pi}{2})"
			self.labels_dict["gghjhumm125"] = "ggH+2j (#alpha=#frac{#pi}{4})"	
			...
			self.labels_dict["tt_mjj"] = "Dijet Mass m_{jj} / GeV"
