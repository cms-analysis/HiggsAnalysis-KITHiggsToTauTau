...
class LabelsDict(labels.LabelsDict):
	def __init__(self, latex_version="latex", additional_labels=None):
		...
		if latex_version == "root":
			...
			self.labels_dict["susycpoddALT"] = "CP-odd"
			...
			for higgs_mass in xrange(90, 161, 5):
				...
				self.labels_dict["susycpoddALT{mass:d}".format(mass=higgs_mass)] = self.labels_dict["susycpoddALT"]
				...
				for scale in [10, 25, 100, 250]:
					...
					self.labels_dict["susycpoddALT{mass:d}_{scale:d}".format(mass=higgs_mass, scale=scale)] = self.labels_dict["susycpoddALT"]+" (#times {scale:d})".format(scale=scale)
			...
			for higgs_mass in xrange(90, 3201, 10):
				...
				for scale in [10, 25, 100, 250]:
					...
					self.labels_dict["susycpoddALT{mass:d}_{scale:d}".format(mass=higgs_mass, scale=scale)] = self.labels_dict["susycpoddALT"]+" (\\times {scale:d})".format(scale=scale)
			...
			for higgs_mass in xrange(90, 161, 5):
				...
				self.labels_dict["susycpoddALT{mass:d}".format(mass=higgs_mass)] = self.labels_dict["susycpoddALT"].replace("H", "H({mass:d})".format(mass=higgs_mass))
