		...
		if channel in ["et", "mt", "em", "tt", "mm", "ee", "ttbar"]:
			if "sameequation" in estimationMethod:
				...
				if kwargs.get("ss_os_factor", 0.0) != 0.0:
					...
					if category != None:
						if channel == "et":
							ss_os_factor = 1.42 if "BoostedCP" in category else 1.00 if "Vbf2D" in category else 1.00 if "ZeroJet2D" in category else 2.18 if "dijet2D" in category else 1.0
						elif channel == "mt":
							ss_os_factor = 1.15 if "BoostedCP" in category else 1.0 if "Vbf2D" in category else 1.18 if "ZeroJet2D" in category else 1.51 if "dijet2D" in category else 1.0
