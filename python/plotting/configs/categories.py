...
class CategoriesDict(object):
	def __init__(self):
		...
		ncombinedmasses = ["1","5","11","13","21","29","31"]
		for i in range(10,100):
			for mass in higgsmasses:
				for X in ncombinedmasses:
					...
					self.categoriesDict["{analysis}{channel}btag_MVAB0."+str(i)+"_M"+mass+"_X"+X+"{discriminator}"] = {
							"channel": [
								"mt_"
								],
							"expressions":{
								"global":"((mt_M%s_X%s_NTrees1500_bbh_vs_bkg>=%i/100.0)*(nbtag>0))"%(mass, X, i),
								"analysis":[
									"catHttMSSM13TeV_"
									],
								},
					...
					self.categoriesDict["{analysis}{channel}nobtag_MVAB0."+str(i)+"_M"+mass+"_X"+X+"{discriminator}"] = {
							"channel": [
								"mt_"
								],
							"expressions":{
								"global":"((mt_M%s_X%s_NTrees1500_bbh_vs_bkg<%i/100.0)*(nbtag>0)+(nbtag<=0))"%(mass, X, i),
								"analysis":[
									"catHttMSSM13TeV_"
									],
								},
				...
				self.categoriesDict["{analysis}{channel}MSSMsig_MVA0."+str(i)+"_M"+mass+"{discriminator}"] = {
						"channel": [
							"mt_"
							],
						"expressions":{
							"global":"(mt_M%s_NTrees1500_htt_vs_bkg>=%i/100.0)"%(mass, i),
							"analysis":[
								"catHttMSSM13TeV_"
								],
							},
				...
				self.categoriesDict["{analysis}{channel}MSSMbkg_MVA0."+str(i)+"_M"+mass+"{discriminator}"] = {
						"channel": [
							"mt_"
							],
						"expressions":{
				...
				for version in range(6):
					self.categoriesDict["{analysis}{channel}btag_MVA0."+str(i)+"_V"+str(version)+"{discriminator}"] = {
							"channel": [
								"mt_"
								],
							"expressions":{
								"global":"(mt_V%i_NTrees1500_bbh_vs_bkg>=%i/100.0)"%(version, i),
								"analysis":[
									"catHttMSSM13TeV_"
									],
								},
					...
					self.categoriesDict["{analysis}{channel}nobtag_MVA0."+str(i)+"_V"+str(version)+"{discriminator}"] = {
							"channel": [
								"mt_"
								],
							"expressions":{
					...
					self.categoriesDict["{analysis}{channel}btag_MVAB0."+str(i)+"_V"+str(version)+"{discriminator}"] = {
							"channel": [
								"mt_"
								],
							"expressions":{
								"global":"((mt_V%i_NTrees1500_bbh_vs_bkg>=%i/100.0)*(nbtag>0))"%(version, i),
								"analysis":[
									"catHttMSSM13TeV_"
									],
								},
					...
					self.categoriesDict["{analysis}{channel}nobtag_MVAB0."+str(i)+"_V"+str(version)+"{discriminator}"] = {
							"channel": [
								"mt_"
								],
							"expressions":{
								"global":"((mt_V%i_NTrees1500_bbh_vs_bkg<%i/100.0)*(nbtag>0)+(nbtag<=0))"%(version, i),
								"analysis":[
									"catHttMSSM13TeV_"
									],
								},
