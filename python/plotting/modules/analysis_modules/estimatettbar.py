...
class EstimateTtbar(estimatebase.EstimateBase):
	...
	def prepare_args(self, parser, plotData):
		...
		self._plotdict_keys = ["ttbar_shape_nicks", "ttbar_data_control_nicks", "ttbar_data_substract_nicks",
		                       "ttbar_mc_signal_nicks", "ttbar_mc_control_nicks"]
	...
	def run(self, plotData=None):
		...
		for ttbar_shape_nick, ttbar_data_control_nick, ttbar_data_substract_nicks, ttbar_mc_signal_nick, ttbar_mc_control_nick in zip(*[plotData.plotdict[key] for key in self._plotdict_keys]):
