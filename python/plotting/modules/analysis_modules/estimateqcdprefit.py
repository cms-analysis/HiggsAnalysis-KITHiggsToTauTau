...
class EstimateQcdPrefit(estimatebase.EstimateBase):
	def __init__(self):
		super(EstimateQcdPrefit, self).__init__()

	def modify_argument_parser(self, parser, args):
		super(EstimateQcdPrefit, self).modify_argument_parser(parser, args)
	...
	def prepare_args(self, parser, plotData):
		super(EstimateQcdPrefit, self).prepare_args(parser, plotData)
