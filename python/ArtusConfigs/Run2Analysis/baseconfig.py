...
class Baseconfig(dict):
    ...
    def __init__(self, nickname):
        ...
        if re.search("Run201", nickname):
            # string in json, possible to change to boolean?
        ...
        if re.search("(Fall15MiniAODv2)", nickname):
            ...
            self["SimpleMuTauFakeRateWeightLoose"] = [
                1.01, 1.007, 0.87, 1.154, 2.281]
            self["SimpleMuTauFakeRateWeightTight"] = [
                1.263, 1.364, 0.854, 1.712, 2.324]
