...
class tt_ArtusConfig(dict):
    ...
    def build_config(self, nickname, *args, **kwargs):
        ...
        self["TauTauTriggerWeightWorkspaceObjectNames"] = [
            "0:t_genuine_TightIso_tt_ratio,t_fake_TightIso_tt_ratio", "1:t_genuine_TightIso_tt_ratio,t_fake_TightIso_tt_ratio"]
        ...
        # TODO change this to boolean? or change the rest to string?
     ...
     # set it here and if it is something else then change it in the ifs below
        ...
        # TODO Ask thomas what it should be line 40 in json
