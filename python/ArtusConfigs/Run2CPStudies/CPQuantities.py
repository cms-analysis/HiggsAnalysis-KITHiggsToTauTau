...
class quantities(run2_quantities.quantities):
    ...
    def build_quantities(self, nickname, *args, **kwargs):
        ...
        # almost the same as 2016 signal, no splitJecUncertaintyQuantities()
    ...
    # TODO Is this really used, very similar to matchedcpquantities
    def genCPQuantities(self, *args, **kwargs):
        return [
