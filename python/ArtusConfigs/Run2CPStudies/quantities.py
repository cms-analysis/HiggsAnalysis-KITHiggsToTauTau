...
class Quantities(Run2Quantities):
	...
	def recoCPQuantities(klass, melaQuantities=True):
		s = [
			...
			"recoPhiStarCPPolVecOneProngTauA1",
			"recoPhiStarCPPolVecTauOneProngA1",
			"recoPhiStarCPPolVecOneProngA1",
			"recoPhiStarCPPolVecTauOneProngA1PiSSFromRho",
			"recoPhiStarCPPolVecTauOneProngA1PiHighPt",
			"recoPhiStarCPPolVecOneProngA1PiSSFromRho",
			"recoPhiStarCPPolVecOneProngA1PiHighPt",
