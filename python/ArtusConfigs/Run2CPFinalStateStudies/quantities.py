...
class Quantities(Run2CPQuantities.Quantities):
	...
	def recoCPFinalStateQuantities(klass, melaQuantities=True):
		...
		s += [
			...
			"calibPhiStarCPComb",
			"calibPhiStarCPCombMerged",
			"calibPhiStarCPCombrPV",
			"calibPhiStarCPCombMergedrPV",
			"calibPhiStarCPCombrPVBS",
			"calibPhiStarCPCombMergedrPVBS",
			"calibPhiStarCPCombHel",
			"calibPhiStarCPCombMergedHel",
