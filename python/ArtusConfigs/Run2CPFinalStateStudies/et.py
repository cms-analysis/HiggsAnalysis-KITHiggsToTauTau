	...
	def build_config(self, nickname, *args, **kwargs):
		...
		if isLegacy:
			...
			self["FakeFactorRooWorkspaceFunction"] = [
				"ff_et_medium_dmbins:pt,dm,njets,e_pt,os,mt,e_iso,pass_single,met_var_qcd,met_var_w,WpT",
				"ff_et_medium_mvadmbins:pt,mvadm,ipsig,njets,e_pt,os,mt,e_iso,pass_single,met_var_qcd,met_var_w,WpT",
				"ff_et_medium_mvadmbins_nosig:pt,mvadm,njets,e_pt,os,mt,e_iso,pass_single,met_var_qcd,met_var_w,WpT",
			]
			if re.search("Run2016|Summer16|Embedding2016", nickname):
				self["FakeFactorFractionsRooWorkspaceFile"] = "root://grid-cms-xrootd.physik.rwth-aachen.de:1094//store/user/azotz/higgs-IC/ff/fake_factors_cpdecay_ipsig1p5_etau_v3/fakefactors_ws_et_lite_2016.root"
			elif re.search("Run2017|Summer17|Fall17|Embedding2017", nickname):
				self["FakeFactorFractionsRooWorkspaceFile"] = "root://grid-cms-xrootd.physik.rwth-aachen.de:1094//store/user/azotz/higgs-IC/ff/fake_factors_cpdecay_ipsig1p5_etau_v3/fakefactors_ws_et_lite_2017.root"
			elif re.search("Run2018|Autumn18|Embedding2018", nickname):
				self["FakeFactorFractionsRooWorkspaceFile"] = "root://grid-cms-xrootd.physik.rwth-aachen.de:1094//store/user/azotz/higgs-IC/ff/fake_factors_cpdecay_ipsig1p5_etau_v3/fakefactors_ws_et_lite_2018.root"
		else:
