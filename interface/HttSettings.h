...
public:
	...
	IMPL_SETTING_DEFAULT(std::string, ChooseMet, "pfMet");
	...
	IMPL_SETTING_DEFAULT(bool, SaveLeptonTauTrigger2017WeightAsOptionalOnly, false);
	IMPL_SETTING_DEFAULT(std::string, LeptonTauTrigger2017WeightWorkspace, "");
	IMPL_SETTING_STRINGLIST_DEFAULT(LeptonTauTrigger2017WeightWorkspaceWeightNames, {});
