...
C     
C     Process: g g > x0 g QNP<=2 WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL VVVS1_2_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_65,GC_11,AMP(1))
      CALL VVV8P0_1(W(1,1),W(1,2),GC_6,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS2_6_0(W(1,4),W(1,5),W(1,3),GC_64,GC_10,AMP(2))
      CALL VVS2_6P0_1(W(1,1),W(1,3),GC_64,GC_10,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL VVV8_0(W(1,2),W(1,4),W(1,5),GC_6,AMP(3))
      CALL VVV8P0_1(W(1,1),W(1,4),GC_6,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL VVS2_6_0(W(1,2),W(1,5),W(1,3),GC_64,GC_10,AMP(4))
