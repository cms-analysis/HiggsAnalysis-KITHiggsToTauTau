...
ProducerBaseUntemplated * HttFactory::createProducer(std::string const& id)
{
	if(id == ElectronEtaSelector().GetProducerId())
	...
	else if(id == PileUpJetIDScaleFactorWeightProducer().GetProducerId())
		return new PileUpJetIDScaleFactorWeightProducer();
	...
	else if(id == FastMttProducer().GetProducerId())
		return new FastMttProducer();
		...
		return new IsomorphicMappingProducer();
	else if(id == QuantileMappingProducer().GetProducerId())
		return new QuantileMappingProducer();
	...
	else if(id == HttEventClassifierTmvaReader().GetProducerId())
		return new HttEventClassifierTmvaReader();
	...
	else if(id == SimpleFitThreeProngThreeProngProducer().GetProducerId())
		return new SimpleFitThreeProngThreeProngProducer();
	...
	else if(id == CPInitialStateQuantitiesProducer().GetProducerId())
		return new CPInitialStateQuantitiesProducer();
