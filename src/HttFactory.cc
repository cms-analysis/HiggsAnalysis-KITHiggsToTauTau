...
ProducerBaseUntemplated * HttFactory::createProducer(std::string const& id)
{
	...
	else if(id == WJetsErsatzReweightingProducer().GetProducerId())
		return new WJetsErsatzReweightingProducer();
	...
	else if(id == WJetsErsatzProducer().GetProducerId())
		return new WJetsErsatzProducer();
	else
