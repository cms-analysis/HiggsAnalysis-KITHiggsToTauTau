...
void HttLambdaNtupleConsumer::Init(setting_type const& settings, metadata_type& metadata)
{
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "metuncorr", metadata.m_commonFloatQuantities["metPtUncorr"]);
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "pfmetuncorr", metadata.m_commonFloatQuantities["pfMetPtUncorr"]);
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "mvametuncorr", metadata.m_commonFloatQuantities["mvaMetPtUncorr"]);
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimet", metadata.m_commonFloatQuantities["puppiMetPt"]);
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimetuncorr", metadata.m_commonFloatQuantities["puppiMetPtUncorr"]);
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimetphi", metadata.m_commonFloatQuantities["puppiMetPhi"]);
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimetcov00", metadata.m_commonFloatQuantities["puppiMetCov00"]);
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimetcov01", metadata.m_commonFloatQuantities["puppiMetCov01"]);
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimetcov10", metadata.m_commonFloatQuantities["puppiMetCov10"]);
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "puppimetcov11", metadata.m_commonFloatQuantities["puppiMetCov11"]);
