...
void HttLambdaNtupleConsumer::Init(setting_type const& settings)
{
	...
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("dphi", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepDPhi"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("dcosphi", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepCosDPhi"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("llangle", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepAngle"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("llmetangle", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepMetAngle"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("theta", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepTheta"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("dtheta", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepDTheta"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("abscostheta", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepAbsCosTheta"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("eta", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepEta"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("costhetastar", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepCosThetaStar"]);
	LambdaNtupleConsumer<KappaTypes>::AddFloatQuantity("costhetastarf", LambdaNtupleConsumer<KappaTypes>::GetFloatQuantities()["diLepCosThetaStarfix"]);
