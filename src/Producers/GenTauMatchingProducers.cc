...
RecoElectronGenTauMatchingProducer::RecoElectronGenTauMatchingProducer() :
	GenTauMatchingProducerBase<KDataElectron>(&product_type::m_genMatchedElectrons,
...
RecoMuonGenTauMatchingProducer::RecoMuonGenTauMatchingProducer() :
	GenTauMatchingProducerBase<KDataMuon>(&product_type::m_genMatchedMuons,
...
RecoTauGenTauMatchingProducer::RecoTauGenTauMatchingProducer() :
	GenTauMatchingProducerBase<KDataPFTau>(&product_type::m_genMatchedTaus,
