...
void HttValidElectronsProducer::Init(setting_type const& settings, metadata_type& metadata)
{
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "leadingEleIso", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata) {
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "leadingEleIsoOverPt", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata) {
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "id_e_mva_nt_loose_1", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata)
	{
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "id_e_cut_veto_1", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata)
	{
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "id_e_cut_loose_1", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata)
	{
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "id_e_cut_medium_1", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata)
	{
	...
	LambdaNtupleConsumer<HttTypes>::AddFloatQuantity(metadata, "id_e_cut_tight_1", [this](event_type const& event, product_type const& product, setting_type const& settings, metadata_type const& metadata)
	{
