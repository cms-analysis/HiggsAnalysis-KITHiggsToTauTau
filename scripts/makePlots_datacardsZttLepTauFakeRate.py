...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Create ROOT inputs and datacards for ZTT lep->tau fake-rate measurement.",
	...
	parser.add_argument("-o", "--output-dir",
	                    default="$CMSSW_BASE/src/plots/ztt_datacards_leptaufakerate/",
	...
	plot_configs = []
	bkg_plotting_order = ["ZL", "ZTT", "ZJ", "TT", "VV", "W", "QCD"]
