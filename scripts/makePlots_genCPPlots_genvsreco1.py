...
if __name__ == "__main__":
	...
	w_reco_dy1=["TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44"]
	w_reco_dy4=["TauMProngEnergy >= 0.55 && TauPProngEnergy >= 0.55"]
	w_reco_dy3=["TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44"]
	w_reco_dy2=["TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44"]


	w_em=["( tauSpinnerWeight000 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44) )",
       "( tauSpinnerWeight025 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight050 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight075 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight100 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))"]
	w_et=[" tauSpinnerWeight000 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44)",
       " tauSpinnerWeight025 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44)",
       " tauSpinnerWeight050 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44)",
       " tauSpinnerWeight075 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44)",
       " tauSpinnerWeight100 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44)"]
	w_mt=["( tauSpinnerWeight000 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight025 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight050 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight075 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))",
       "( tauSpinnerWeight100 * tauSpinnerWeightInvSample && (TauMProngEnergy >= 0.44 && TauPProngEnergy >= 0.44))"]
	w_tt=["( tauSpinnerWeight000 * tauSpinnerWeightInvSample)",
       "( tauSpinnerWeight025 * tauSpinnerWeightInvSample )",
       "( tauSpinnerWeight050 * tauSpinnerWeightInvSample )",
       "( tauSpinnerWeight075 * tauSpinnerWeightInvSample )",
	...
	names=["_genvsreco1_em","_genvsreco1_et","_genvsreco1_mt","_genvsreco1_tt"]
	...
	for j in xrange(4):	
		config2=jsonTools.JsonDict(os.path.expandvars("$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/plots/configs/gen_CP/phiCPevenandodd_genvsreco1.json"))		
		config2["folders"]= [f_gen[j],f_gen[j],f_reco[j],f_reco[j]]	
		config2["colors"]=["kRed","kRed","kBlack", "kBlack"]
