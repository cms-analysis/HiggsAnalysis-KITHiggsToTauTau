for WORKSPACE in $1/cmb/125/htt_mt_2017_*_cpmixture.root; do
	echo combineTool.py -M FitDiagnostics --redefineSignalPOIs alpha -v 1 --there -m 125 --parallel 8 --robustFit 1 --preFitValue 0.0 --cminDefaultMinimizerType Minuit2 --cminDefaultMinimizerAlgo Minuit2 --cminDefaultMinimizerStrategy 0 --cminFallbackAlgo Minuit2,0:1.0 \
		-d $1/cmb/125/ws.root \
		-n `echo ${WORKSPACE} | sed -e "s@$1/cmb/125/htt_mt_2017_@.alpha@g"| sed -e "s@_13TeV_cpmixture.root@@g"`
done | runParallel.py -n 12
