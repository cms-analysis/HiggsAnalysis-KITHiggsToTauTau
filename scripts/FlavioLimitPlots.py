...
def plot_limit(channel, methods, categories, print_limits):
	...
	for category in categories:
		for method in methods:
			limit_file = ROOT.TFile(os.environ["CMSSW_BASE"] + "/src/FlavioOutput/Limits/{}/limit_{}_{}.root".format(channel, category, method), "READ")
			...
			if print_limits:
				print "Limit for category/method {}/{}: {}".format(category, method, limit[2])
	...
	lumi.DrawLatexNDC(0.55, 0.905, "35.87 fb^{-1} (2016, 13 TeV)")
