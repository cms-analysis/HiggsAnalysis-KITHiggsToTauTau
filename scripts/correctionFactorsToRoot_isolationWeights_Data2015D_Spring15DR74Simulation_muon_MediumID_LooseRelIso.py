...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Store correction factors in ROOT histograms. Here: isolation weights (MT channel, Medium muon ID, LooseRelIso, Data2015D, MC 	Spring15DR74)",
	...
	parser.add_argument("-o", "--output",
	                    default="$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/identificationWeights/isolationWeights_Data2015D_Spring15DR74Simulation_muon_MediumID_LooseRelIso.root",
	                    help="Output ROOT file. [Default: %(default)s]")

	args = parser.parse_args()
	logger.initLogger(args)
	
	input_file = os.path.join(args.input_dir,"MuonIso_Z_RunD_Reco74X_Nov20.root")
	input_path = "NUM_LooseRelIso_DEN_MediumID_PAR_pt_spliteta_bin1/pt_abseta_ratio"
