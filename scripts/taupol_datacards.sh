...
$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/scripts/makePlots_datacardsZttPolarisation_shared.py -i $1 -n 8 -o $2/combinedOmegaVisible -c tt --categories tt_combined_rho_rho --clear-output-dir --use-asimov-dataset --omega-version VisibleSvfit
