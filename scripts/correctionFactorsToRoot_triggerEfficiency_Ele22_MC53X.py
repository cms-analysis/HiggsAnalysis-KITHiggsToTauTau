...
if __name__ == "__main__":
	...
	parser.add_argument("-o", "--output",
	                    default="$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/triggerEfficiency_Ele22_MC53X.root",
	...
	eta_bins_with_parameters = [
		{
			...
			"parameters" : [22.1217, 1.34054, 1.8885, 1.01855, 4.7241],
		},
		{
			"low" : -eta_border_eb_ee,
			"high" : eta_border_eb_ee,
			"parameters" : [21.7243, 0.619015, 0.739301, 1.34903, 1.02594],
		},
		{
			"low" : eta_border_eb_ee,
			"high" : 10.0,
