...
if __name__ == "__main__":
	...
	parser = argparse.ArgumentParser(description="Store correction factors in ROOT histograms. Here: isolation weights (MT channel, Medium muon ID, TightRelIso, Data2015D, MC 	Spring15DR74)",
	...
	parser.add_argument("-o", "--output",
	                    default="$CMSSW_BASE/src/HiggsAnalysis/KITHiggsToTauTau/data/root/identificationWeights/isolationWeights_Data2015D_Spring15DR74Simulation_muon_MediumID_TightRelIso.root",
